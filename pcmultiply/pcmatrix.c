...
// Global variables for tracking produced and consumed matrices
int produced_count = 0;
int consumed_count = 0;
int total_matrices_to_produce = 0; // Set this based on NUMBER_OF_MATRICES
...
int main (int argc, char * argv[])
{
 ...
 // setting based on number of matrices after command line processing
  total_matrices_to_produce = NUMBER_OF_MATRICES;
//================================================================================================
  ...
  // Allocate memory for thread identifiers, based on numw
  pthread_t producers[numw], consumers[numw];
